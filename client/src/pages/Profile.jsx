        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center'>
          <div className='bg-white p-4 rounded-lg shadow-lg'>
            ...
            <div className='flex justify-center gap-4'>
              <button onClick={confirmDeleteListing} className='bg-red-700 text-white px-4 py-2 rounded-lg'>Yes</button>
              <button onClick={cancelDelete} className='bg-gray-700 text-white px-4 py-2 rounded-lg'>No</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showDeleteAccountPopup && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center'>
          <div className='bg-white p-4 rounded-lg shadow-lg'>
            ...
            <div className='flex justify-center gap-4'>
              <button onClick={confirmDeleteAccount} className='bg-red-700 text-white px-4 py-2 rounded-lg'>Yes</button>
              <button onClick={cancelDeleteAccount} className='bg-gray-700 text-white px-4 py-2 rounded-lg'>No</button>
            </div>
          </div>
        </div>
      )}
