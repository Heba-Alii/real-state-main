    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="w-full grid md:grid-cols-2 gap-4 items-start bg-white ">
            {listing && (
              <div className="xl:p-4 md:col-span-1 md:p-1 bg-white rounded-lg ">
                <TexteArea
                  listing={listing}
                  contact={contact}
            ...
            <div
              id="imageContainer"
              className="p-4 md:col-span-1 md:p-0 cursor-pointer mt-14"
              onClick={openPopup}
            >
              <MediaSection
