...
const MediaSection = ({ imageUrls, videoUrls }) => {
    ...
    >
      <div className="flex items-center justify-center flex-col mt-1 h-auto  ">
        <img
          src={imageUrls[0]}
          alt="First Image"
          className="inset-0 w-full object-cover mb-4 px-1 rounded-xl"
        /> 
      </div>

      <div className="flex justify-center items-start mt-1 bg-white">
 ...
 {imageUrls[1] && videoUrls[0] && (
          <img
            src={imageUrls[1]}
            alt="Second Image"
            className="w-1/3 h-full object-cover px-1 rounded-xl"
            style={{ width: mediaItemWidth, height: mediaItemHeight }}
          />
        )}
        ...
        {imageUrls[2] && (
          ...
          >
            <img
              src={imageUrls[2]}
              alt="Third image"
              className="w-full h-full object-cover px-1 rounded-xl"
              style={{ height: mediaItemHeight }}
            />
